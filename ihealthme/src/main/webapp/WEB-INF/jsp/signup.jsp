                                    ...
                                    <div class="art-postcontent art-postcontent-0 clearfix"><div class="">
                                            <div class="">
                                                <div class="" style="width: 100%" >
                                                    ...
                                                    <form action="register.html" method="POST" class="bs-example form-horizontal">
                                                        <fieldset>
                                                            <legend></legend>
                                                            <c:choose>
                                                                <c:when test="${requestScope.success ne null}">
                                                                    <div class="alert alert-dismissable alert-success">
                                                                        ...
                                                                        <strong>Well done!</strong> ${requestScope.success} <a href="news.html">View News now !!</a>
                                                                    </div>
                                                                </c:when>
                                                                <c:when test="${requestScope.fail ne null}">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    <input class="form-control" id="firstName" name="fn" placeholder="First Name" style="width: 380px;">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="surName" class="col-lg-2 control-label">Sur-Name</label>
                                                                <div class="col-lg-10">
                                                                    <input type="text" class="form-control" id="surName" name="sn" placeholder="Sur-Name" style="width: 380px;">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    <input type="password" class="form-control" id="conftPassword" name="cpw" placeholder="Confirm Password" style="width: 380px;">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
